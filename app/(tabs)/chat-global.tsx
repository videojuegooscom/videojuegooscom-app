...
export default function ChatGlobalScreen() {
  /**
   * DEMO VISUAL
   * Cambia estos dos flags para probar estados del producto:
   *
   * - isLoggedIn: usuario con cuenta iniciada
   * - hasCompletedCommunityProfile: usuario con perfil comunitario completo
   *
   * Regla actual de demo:
   * - si no está logeado => puede mirar, pero no escribir ni ver multimedia real
   * - si está logeado pero perfil incompleto => le pedimos completar perfil
   * - si está logeado y perfil completo => puede participar
   */
        ...
        >
          ...
          >
            <View style={{ gap: 8 }}>
              ...
              >
                Comunidad en tiempo real para hablar de stock, ofertas, soporte público,
                packs, reparaciones y movimiento de la tienda. Mirar puede mirar cualquiera.
                Participar no.
              </Text>
            </View>
            ...
            >
              <StatPill label="Personas viendo ahora" value={String(totalViewers)} />
              <StatPill label="Usuarios registrados online" value={String(registeredOnline)} />
              <StatPill label="Mensajes visibles" value={String(totalMessages)} />
            ...
            {!isLoggedIn ? (
              <>
                <Text style={{ color: COLORS.muted, lineHeight: 22 }}>
                  Estás entrando como visitante. Puedes ver el chat y quién está dentro,
              ...
              <>
                <Text style={{ color: COLORS.muted, lineHeight: 22 }}>
                  Ya has iniciado sesión, pero para escribir en el chat tienes que completar
          ...
          >
                ...
                >
                  <View style={{ flex: 1, minWidth: 220 }}>
                    ...
                    <Text style={{ color: COLORS.muted, marginTop: 4 }}>
                      Todo el mundo puede mirar. Solo los usuarios verificados pueden hablar.
                    </Text>
                  </View>
            ...
            >
              ...
              >
                ...
                <FeatureLine text="Chat visible para todo el mundo" />
                <FeatureLine text="Visitantes sin registro: solo lectura" />
                <FeatureLine text="Usuarios registrados: identidad real + username público" />
                <FeatureLine text="Presencia en tiempo real: quién comenta y quién solo mira" />
                <FeatureLine text="Multimedia restringida para visitantes" />
                <FeatureLine text="Moderación, reportes y bloqueo futuro" />
              </View>
              ...
              >
                ...
                <Text style={{ color: COLORS.muted, lineHeight: 22 }}>
                  Después de validar esta pantalla, toca construir la base real en Supabase:
                  perfiles comunitarios, mensajes, presencia en vivo, permisos por rol y
                  multimedia bloqueada según estado del usuario.
                </Text>
              </View>
            </View>
          </View>
...
function MessageBubble({
  ...
  const roleTone =
    item.role === "admin"
      ? { bg: "rgba(0,170,228,0.18)", text: "#BAE6FD", border: "rgba(0,170,228,0.30)", label: "ADMIN" }
      : item.role === "vip"
      ? { bg: "rgba(216,176,74,0.16)", text: "#FDE68A", border: "rgba(216,176,74,0.30)", label: "VIP" }
      : { bg: "rgba(255,255,255,0.06)", text: "#FFFFFF", border: "rgba(255,255,255,0.12)", label: "MIEMBRO" };
...
function FeatureLine({ text }: { text: string }) {
  return (
    <View style={{ flexDirection: "row", alignItems: "flex-start", gap: 10 }}>
      ...
      />
      <Text style={{ color: COLORS.muted, flex: 1, lineHeight: 22 }}>{text}</Text>
    </View>
  );
}